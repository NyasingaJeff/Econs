                ...
                if ($withCustomFields && !$onlyID && is_array($addrCustomFields) && count($addrCustomFields) > 0){
                    ...
                    foreach ($addrCustomFields as $cK => $cF){
                        ...
                        // addr1
                            ...
                            // add as subquery
                            $extraSelect .= ',(SELECT zbscf_objval FROM '.$ZBSCRM_t['customfields']." WHERE zbscf_objid = contact.ID AND zbscf_objkey = %s AND zbscf_objtype = %d LIMIT 1) '".$cKey2."'";                        
                            // add params
    ...
    public function getContacts($args=array()){
        ...
        #} ============= PRE-QUERY ============
            ...
            $field_map = array(
                ...
                // following will only work if total value subqueries triggered above ^
            ...
            if ( array_key_exists( $sortByField, $field_map ) ) {
                $sortByField = $field_map[ $sortByField ];
            } 
